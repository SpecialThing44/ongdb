...
import org.neo4j.cypher.{ExecutionEngineTestSupport, GraphDatabaseTestSupport, QueryPlanTestSupport}
...
abstract class EnterpriseExecutionEngineFunSuite
  extends CypherFunSuite with GraphDatabaseTestSupport with EnterpriseExecutionEngineTestSupport with QueryPlanTestSupport {
