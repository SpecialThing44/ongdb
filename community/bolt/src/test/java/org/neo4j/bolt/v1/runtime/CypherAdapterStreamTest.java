...
//        assertThat( meta.get( "stats" ), equalTo( asParameterMapValue( mapValues(
...
//
//        // Then
//        Map<String,Object> expectedChild = mapValues(
//                "args", asParameterMapValue( mapValues( "arg2", intValue( 1 ) ) ),
//                "identifiers", list( stringValue( "id2" ) ),
//                "operatorType", stringValue( "Scan" ),
//                "children", VirtualValues.EMPTY_LIST
//        );
//        Map<String,Object> expectedPlan = mapValues(
//                "args", asParameterMapValue( mapValues( "arg1", intValue( 1 ) ) ),
//                "identifiers", list( stringValue( "id1" ) ),
//                "operatorType", stringValue( "Join" ),
//                "children", list( asParameterMapValue( expectedChild ) )
//        );
//        assertThat( meta.get( "plan" ), equalTo( asParameterMapValue( expectedPlan ) ) );
//    }
//
//    @Test
...
//        );
//
//        Map<String,Object> expectedProfile = mapValues(
//                "args", asParameterMapValue( mapValues( "arg1", intValue( 1 ) ) ),
//                "identifiers", list( stringValue( "id1" ) ),
//                "operatorType", stringValue( "Join" ),
//                "children", list( asParameterMapValue( expectedChild ) ),
...
//        );
//
//        assertMapEqualsWithDelta( (MapValue.MapWrappingMapValue) meta.get( "profile" ), asParameterMapValue( expectedProfile ), 0.0001 );
//    }
//
//    private Map<String,Object> mapValues( Object... values )
//    {
...
//
//        // Then
//        Map<String,Object> msg1 = mapValues(
...
//        );
//        Map<String,Object> msg2 = mapValues(
//                "severity", stringValue( "WARNING" ),
...
//                "position", asParameterMapValue( mapValues( "offset", intValue( 4 ), "column", intValue( 6 ), "line", intValue( 5 ) ) )
//        );
//
//        assertThat( meta.get( "notifications" ),
//                equalTo( list( asParameterMapValue( msg1 ), asParameterMapValue( msg2 ) ) ) );
//    }
//
...
//            }
//        } );
//        return asParameterMapValue( meta );
//    }
//
//    private static void assertMapEqualsWithDelta( MapValue.MapWrappingMapValue a, MapValue.MapWrappingMapValue b, double delta )
//    {
...
//                assertMapEqualsWithDelta( (MapValue.MapWrappingMapValue) aValue, (MapValue.MapWrappingMapValue) bValue, delta );
//            }
