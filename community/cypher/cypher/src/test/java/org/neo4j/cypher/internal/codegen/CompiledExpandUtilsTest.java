...
//        PlatformModule platform = resolver.resolveDependency(PlatformModule.class);
//        return new ClassicCoreSPI(platform, datasource, logger, availability).beginTransaction( implicit, LoginContext.AUTH_DISABLED, 100 );
//    }
//
//    @Test
